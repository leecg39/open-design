    ...
    function expandSearchCommand(
      ...
      return {
        ...
        prompt: [
          ...
          'The saved report must include the query, fetched time, short summary, key findings, source list with [1], [2] citations, raw evidence excerpts when rawContent is present, and a note that source content is external untrusted evidence.',
